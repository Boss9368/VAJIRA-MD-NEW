...
SESSION_ID:VAJIRA-MD=7ddmSQ7K#8v49h-nVgqc-AugeRqm4bEoDHF0JDJ-OqMURGPMirmw process.env.SESSION_ID === undefined ? '' : process.env.SESSION_ID,
OWNER_NUMBER:+923480388763 process.env.OWNER_NUMBER === undefined ? '' : process.env.OWNER_NUMBER,   
